...
The plugin is simple to install and use. Even a very novice user can install and use the plugin. And I'm sure you are good than that. ;)<br>
No need to edit any code.<br>
For a easy installation guide checkout the <a 
href="http://wordpress.org/extend/plugins/guest-posts/installation/"><strong>Installation</strong></a> tab above.
...
<ul>
	<li>User selectable category</li>
	<li>Captcha validation</li>
	<li>A nice Admin Panel</li>
</ul>
...
You: Oh God, 35 seconds gone and still I'm not done. What will I do now!!!!?<br>
Me: Don't worry my boy, I'm here for you. Just follow me.
<ul>
...
You: Is it really so simple? I still have 35 seconds left. What can I do at this time?<br>
Me: Yes it's so simple. You may leave a review with 5 star feedback in this time. :)
...
2. Guest Posts activated on Fronend.
