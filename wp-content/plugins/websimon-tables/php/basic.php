...
$table_class = $design_elements[16];
$cell_spacing = $design_elements[17];
					...
					<div id="poststuff">
						<div id="namediv" class="stuffbox">
							...
							<script type="text/javascript">
								...
								<p>
									Custom cell Spacing:<input type="text" id="cell_spacing" name="cell_spacing" style="width: 50px;" value="' . $cell_spacing . '"/>px
								</p>
								<p>
								...
								<p>
									Table Class:<input type="text" id="table_class" name="table_class" style="width: 200px;" value="' . $table_class . '"/>
								</p>
								<p>
								Column width:<br />';	
									$i = 1;
