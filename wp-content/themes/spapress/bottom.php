		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/spapress/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://smthemes.com/soundwaves/' target='_blank'>Free WordPress themes</a>, thanks to: <a href='http://www.streamline-surgical.com' target='_blank'>gastric banding</a>, <a href='http://npkid.com/homebirth-midwife-what-you-should-know/' target='_blank'>Homebirth</a> and <a href='http://fthe.me/vincie-web-responsive-modern-wordpress-theme/' target='_blank'>Website templates</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
	</div> <?php //footer ?>
