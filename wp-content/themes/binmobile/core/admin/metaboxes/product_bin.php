...
<table class="form-table">
    <tbody>
        ...
        <tr>
            <th><label for="product-sub-title"><?php esc_html_e('Sub Title', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('sub-title'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="product-sub-title" />
                <p class="description">
        ...
        <tr>
            <th><label for="product-short-desc"><?php esc_html_e('Short Description', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('short-desc'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="product-short-desc" />
                <p class="description">
        ...
        <tr>
            <th><label for="product-video"><?php esc_html_e('Video', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('video'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="product-video" />
                <p class="description">
