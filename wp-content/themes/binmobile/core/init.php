...
if (!class_exists($bip_core_class)) {
    class BipCore{
        ...
        public static function printFooterScripts(){?>
			<script>function showVideo(e) {
				jQuery('#productVideo').modal();
				var playBtn = jQuery('.vjs-big-play-button').css('display');
				if(playBtn=='block'){
					jQuery('.vjs-big-play-button').trigger('click');
				}
				if(jQuery('.vjs-play-control.vjs-paused')[0]){
					jQuery('.vjs-play-control').trigger('click');
				}
			};
			jQuery(document).ready(function(e) {
				jQuery('.modal .close').click(function(){console.dir(jQuery('.vjs-play-control.vjs-playing')[0]);
					if(jQuery('.vjs-play-control.vjs-playing')[0]){
						jQuery('.vjs-play-control').trigger('click');
					}
				});
			});</script>
        ...
        public static function loadScripts(){
            ...
            wp_register_script( self::prefix('scrollTo'), $template_directory_uri . '/assets/js/jquery.scrollTo-1.4.3.1-min.js', array('jquery'), '1.4.3.1', true);
            wp_register_script( self::prefix('localscroll'), $template_directory_uri . '/assets/js/jquery.localscroll-1.2.7-min.js', array('jquery'), '1.2.7', true);
			...
			wp_register_script( self::prefix('video-js'), $template_directory_uri . '/assets/video-js/video.js');
			...
			if(is_home() || is_front_page()){
				wp_enqueue_script(self::prefix('video-js'));
			}
            wp_enqueue_script(self::prefix('modernizr.custom'));
            wp_enqueue_script(self::prefix('mobilemenu'));
            wp_enqueue_script(self::prefix('scrollTo'));
            wp_enqueue_script(self::prefix('localscroll'));
        ...
        public static function createPostTypes(){
            ...
            $tariff_args = array(
                    'labels' => array(
                        'name' => __( 'Tariff Table', BIP_DOMAIN),
            ...
            register_post_type('tariff_table', $tariff_args);
