	...
	<div class="container row">
        ...
        <div class="loginUserContainer" id="loginDivInner">
            <div class="loginUserArea" id="loginArea" style="display:none;">
                ...
                <h2 class="forgtmsg" style="display:none;">Recover to Chalksy</h2>
                ...
                <form id="frmLogin" method="post" action="<?php echo home_url( '/wp-login.php')?>">
                	<p class="loginInputFields">
                        ...
                        <div>(<a href="<?php echo home_url( '/wp-login.php')?>">forgot?</a>) or <a href="<?php echo home_url( '/register.php')?>">Register</a>
...
<div class="container">
    ...
    <!-- Navigation -->
    <?php $menu_result = wp_nav_menu( array( 'fallback_cb' => array('BipCore', 'emptyMenuFallback'), 'depth' => 2, 'menu_class' => 'primary-nav', 'theme_location' => BipCore::TOP_MENU_LOCATION, 'container' => 'nav') ); ?>
    <?php if ($menu_result === false) BipCore::emptyMenuFallback(array()); // For wp 3.5 only ?>
   	</div>
    <!-- Search -->
    <div class="search span2 pull-right">
    	<div class="row-fluid">
        <form action=""  method="get" role="search" >
            <input type="text" name="s" value="" class="span9">
            <input type="submit" value="<?php _e('',BIP_DOMAIN)?>" name="searchsubmit" class="button span2 offset">
        </form>
        </div>
    </div>
    <div class="clear"></div>
