    	...
    	<div class="container">
            ...
            <div class="row section1">
                ...
                <div class="span6 right">
               		<span class="smaller">Assistenza clienti: <b class="title-color">4050</b></span>
           	...
           	<div class="row section2"> 
            	<div>
                    <div class="span4">
                    	<img class="pull-left" src="<?php echo WPTHEME_URL.'/assets/img/soddisfatti.png';?>"/>
                    	<a class="pull-left"><div>SODDISFATTI</div><div>O RIMBORSATI</div></a>
                    </div>
                    <div class="span4">
                    	<img class="pull-left" src="<?php echo WPTHEME_URL.'/assets/img/spedizione.png';?>"/>
                    	<span><a class="pull-left" ><div>SPEDIZIONE</div><div>GRATUITA</div></a></span>
                    </div>
                    <div class="span4">
                    	<img class="pull-left" src="<?php echo WPTHEME_URL.'/assets/img/pagamenti.png';?>"/>
            ...
            <div class="row section3">   
                <div>
                    ...
                    <div class="span8">
                    	<h3 class="title-color">CI TROVI ANCHE SU: 
                        	<span class="">
                                <img src="<?php echo WPTHEME_URL.'/assets/img/fLikes.png';?>" />
                                <img src="<?php echo WPTHEME_URL.'/assets/img/tLikes.png';?>" />
                                <img src="<?php echo WPTHEME_URL.'/assets/img/gLikes.png';?>" />
                            </span>
                        </h3>
                    </div>
                </div>
