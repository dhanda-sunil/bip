<?php echo BipCoreAdmin::itemBackend($mb, 'tariff'); ?>
...
<table class="form-table">
    <tbody>
        ...
        <tr>
            <th><label for="tariff-des-link"><?php esc_html_e('Description Link', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('des-link'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="tariff-des-link" />
                <p class="description">
        ...
        <tr>
            <th><label for="tariff-bottom-box1-link"><?php esc_html_e('Bottom Box 1 Link', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('bottom_box1_link'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="tariff-bottom-box1-link" />
                <p class="description">
        ...
        <tr>
            <th><label for="tariff-bottom-box2-link"><?php esc_html_e('Bottom Box 2 Link', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('bottom_box2_link'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="tariff-bottom-box2-link" />
                <p class="description">
        ...
        <tr>
            <th><label for="tariff-box-icon"><?php esc_html_e('Homepage Box Icon', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('box-icon'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="tariff-box-icon" />
                <p class="description">
        ...
        <tr>
            <th><label for="tariff-slider-icon"><?php esc_html_e('Slider Icon', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('slider-icon'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="tariff-slider-icon" />
                <p class="description">
        ...
        <tr>
            <th><label for="tariff-short-des-1"><?php esc_html_e('Short Description 1', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('short-des-1'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="tariff-short-des-1" />
                <p class="description">
        ...
        <tr>
            <th><label for="tariff-short-des-2"><?php esc_html_e('Short Description 2', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('short-des-2'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="tariff-short-des-2" />
                <p class="description">
        ...
        <tr>
            <th><label for="tariff-desc"><?php esc_html_e('Description', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('description'); ?>
                <textarea name="<?php $mb->the_name(); ?>" id="tariff-desc"><?php $mb->the_value(); ?></textarea>
                <p class="description">
                    <?php esc_html_e('Description of Tariff', BIP_DOMAIN) ?>
                </p>
            </td>
        </tr>
        <tr>
            <th><label for="tariff-button-text"><?php esc_html_e('Button Text', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('button-text'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="tariff-button-text" />                
            </td>
        </tr>
        <tr>
            <th><label for="tariff-video-1"><?php esc_html_e('Video 1', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('video_1'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="tariff-video-1" />
                <p class="description">
        ...
        <tr>
            <th><label for="tariff-video-image-1"><?php esc_html_e('Video 1 Placeholder', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('video_1_image'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="tariff-video-image-1" />
            </td>
        </tr>
        <tr>
            <th><label for="tariff-video-2"><?php esc_html_e('Video 2', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('video_2'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="tariff-video-2" />
                <p class="description">
        ...
        <tr>
            <th><label for="tariff-video-image-2"><?php esc_html_e('Video 2 Placeholder', BIP_DOMAIN); ?></label></th>
            <td>
                <?php $mb->the_field('video_2_image'); ?>
                <input type="text" value="<?php $mb->the_value(); ?>" name="<?php $mb->the_name(); ?>" id="tariff-video-image-2" />
            </td>
        </tr>
        <tr>
