...
if ( function_exists('register_sidebar') ) {
	...
	register_sidebar(array(
		...
		'before_title' => '<div align="center" class="newsletter-title2" onclick="window.location.href=\'http://amirahmadi.com/english/?page_id=273\'"><img src="'.get_template_directory_uri().'/images/newsletter.png'.'"/></div><div class="title"><h1><span>',
...
function icy_wp_login_title() {
	echo get_option('blogname');
}
add_filter('login_headertitle', 'icy_wp_login_title');
...
function icy_wp_login_url() {
	echo home_url();
}
add_filter('login_headerurl', 'icy_wp_login_url');
