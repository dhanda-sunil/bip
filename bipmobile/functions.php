...
/*-----------------------------------------------------------------------------------*/
define('WPSITE_URL', get_bloginfo('url'));
...
add_filter( 'the_content', 'autop_clear' );
...
function renderProductBottomBoxes($bottom_box2_link='#'){
	...
	$output .= '</div>';
	$output .= '<div class="span3 border gray">';
		$output .= '<a href="'.WPSITE_URL.'/utilita/contatti/"><div class="center image"><img src="'.WPTHEME_URL.'/assets/img/icona_04.jpg'.'"></div>';
		$output .= '<div><h6 class="center">'.$options[$shortname.'_productpage_bottombox4_title'].'</h6></div></a>';
